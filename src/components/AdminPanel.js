    ...
    return (
        <div className={`min-h-screen ${darkMode ? 'dark bg-stone-900' : 'bg-lime-50'}`}>
            <div className="flex">
                ...
                />
                <div className={`flex-1 flex flex-col transition-all duration-300 ease-in-out ${sidebarOpen ? 'md:ml-0' : 'md:ml-0'}`}>
                    <Navbar
                        toggleSidebar={toggleSidebar}
                    ...
                    <div className={`${collapsed ? 'md:ml-20' : 'md:ml-64'} transition-all duration-300`}>
                        <main className="flex-1 overflow-y-auto overflow-x-hidden p-4 md:p-6">
                            <Routes>
                                ...
                                {/* Vendors */}
                                <Route path="/vendors" element={<Vendors darkMode={darkMode} collapsed={collapsed} />} />
                                <Route path="/vendorapplications" element={<PendingVendors darkMode={darkMode} collapsed={collapsed} />} />
